...
namespace BMHRI.WCS.Server.UserControls
{
    ...
    /// SenceUC.xaml 的交互逻辑
    /// </summary>
    public partial class SenceUC : UserControl
    {
        double ScaleX = 1;
        double ScaleY = 1;
        double offsety = 0;
        ...
        private void CreateDDJUI(BaseModel baseModel)
        {
            ...
            if (baseModel.PLCID == "DDJ03") 
            {
                ...
                if (dDJDevice.PLCID == "DDJ03")
                    binding.Converter = new YMontionPositionConverter(MyCanvas.Height*0.0938566552901, MyCanvas.Height * 0.86433447098976, "1");
            ...
            else
            {
                ...
                if (dDJDevice.PLCID == "DDJ01" )
                    binding.Converter = new XDmMontionPositionConverter(MyCanvas.Width*0.068359375, MyCanvas.Width * 0.76416015625, "1");
                else
                    binding.Converter = new XDmMontionPositionConverter(MyCanvas.Width * 0.0634765625, MyCanvas.Width * 0.76904296875, "2");
                binding.ConverterCulture = new CultureInfo("en-US");
